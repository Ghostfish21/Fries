...
namespace Fries.Ilpp.MultiTagIl {
    public class MultiTagInjector : ILPostProcessor {
        # region 日志
...
# endif
        ...
        public override ILPostProcessResult Process(ICompiledAssembly compiledAssembly) {
            try {
                ...
                log(compiledAssembly.Name, "MultiTag Ilpp started...");

                if (!WillProcess(compiledAssembly)) {
                    log(compiledAssembly.Name, "MultiTag Ilpp exited due to invalid assembly...");
                    return null;
                }
